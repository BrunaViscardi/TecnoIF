            ...
            <form action="{{route('painel.mentorado.createEquipe', $projeto->id)}}" method="post">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>Nome</label>
                        <input name="nome" class="form-control @error('nome') is-invalid @enderror"  placeholder="Nome do Projeto">
                        @error('nome')
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <label>CPF</label>
                            <input name="cpf" type="text" class="form-control @error('cpf') is-invalid @enderror">
                            @error('cpf')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <label>Turno</label>
                            <input name="turno" type="text" class="form-control @error('turno') is-invalid @enderror">
                            @error('turno')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col">
                            <label>Período</label>
                            <input name="periodo" type="text" class="form-control @error('periodo') is-invalid @enderror">
                            @error('periodo')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="endereco" class="form-control @error('endereco') is-invalid @enderror" placeholder="Endereço">
                        @error('endereco')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
