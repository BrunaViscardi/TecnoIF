        ...
        <div class="card card-success">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea disabled name="problemas" class="form-control" rows="3" placeholder="..."  >{{$projeto->problemas}}</textarea>
                </div>
                <div class="form-group">
                    <label>Quais as características da sua solução? Quais são seus diferenciais?</label>
                    <textarea disabled name="caracteristicas" class="form-control" rows="3" placeholder="..." >{{$projeto->caracteristicas}}</textarea>
                </div>
                <div class="form-group">
                    <label>Quem é o seu público alvo?</label>
                    <textarea disabled name="publico_alvo" class="form-control" rows="3" placeholder="..." >{{$projeto->publico_alvo}}</textarea>
                </div>
                <div class="form-group">
                    <label>Quais são as dificuldades e necessidades para realizar a ideia?</label>
                    <textarea disabled name="dificuldades" class="form-control" rows="3" placeholder="..." >{{$projeto->dificuldades}}</textarea>
                </div>
                <div class="form-group">
                    <label>Qual a tua disponibilidade e motivação para desenvolver o projeto?</label>
                    <textarea disabled name="disponibilidade" class="form-control" rows="3" placeholder="..." >{{$projeto->disponibilidade}}</textarea>
                </div>
                <div class="form-group">
                    <label>Quais são os resultados esperados?</label>
                    <textarea disabled name="resultados" class="form-control" rows="3" placeholder="..." >{{$projeto->resultados}}</textarea>
                </div>
                <div class="form-group">
                    <label>Indicação do pesquisador / mentor</label>
                    <input disabled value="{{$projeto->nomeMentor}}" name="nomeMentor" class="form-control" placeholder="Nome do mentor" >
                    <small class="form-text text-muted">Insira o nome completo</small>
                </div>
                <div class="form-group">
                    <label>Instituição</label>
                    <input disabled value="{{$projeto->instituicao}}" name="instituicao" class="form-control" placeholder="Instituição" >
                    <small class="form-text text-muted">Insira a instituição em que seu mentor trabalha</small>
                </div>
                <div class="form-group">
                    <label>Área </label>
                    <input disabled value="{{$projeto->areaMentor}}" name="areaMentor" class="form-control" placeholder="Área de atuação" >
                    <small class="form-text text-muted">Insira a área de atuação do seu mentor</small>
                </div>
                <div class="form-group">
                    <label>Email </label>
                    <input disabled value="{{$projeto->email}}" name="email" class="form-control" placeholder="Email" >
